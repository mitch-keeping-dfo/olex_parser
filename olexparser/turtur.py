...
class TurTur:
    ...
    # def parse_segment_files(self):
    #     for summary in self.segments_summaries:
    #         seg_num = summary.get_seg_num()
    #         segment_file_name = "segment{}_A".format(seg_num)
    #         self.segments[seg_num] = SegmentFile(segment_files[segment_file_name])
    #         if segment_file_name in segment_files.keys():
    #             segment_files_parsed.append(self.segments[seg_num])
    #             segment_files.pop(segment_file_name)
    #     return
    ...
    #     """
    #
    #     :return:  the dictionary of segments with key:value of
    #     """
    ...
    def get_segment_summaries(self):
        ...
        return self.segments_summaries
    ...
    def get_warnings(self):
        """
        :return: a list of warnings generated by the TurTur
        :rtype: list
        """
