...
class RuteEntry:
    ...
    :type icon: str
    :var self.lat: the "Olex float" of a latitude coordinate
    :var self.long: the "Olex float" of a longitude coordinate
    :var self.timestamp: a Unix timestamp
    :var self.icon: a string describing the icon used for the entry
    :var self.warnings: A list of warnings generated by the :class:`RuteEntry<olexparser.rute_entry.RuteEntry>` class
    """
