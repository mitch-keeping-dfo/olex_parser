...
class Rute:
    ...
    :var self.rute_entries: list of :class:`RuteEntry` entries for the Rute
    ...
    :var self.warnings: A list of warnings generated by the :class:`Rute<olexparser.Rute>` class
