...
class SegmentFile:
    ...
    See :class:`olexparser.segment_entry.SegmentEntry` for a description of an segment entry.
    ...
    def get_warnings(self):
        """Returns any warnings generated by the class
        :return: Returns any warnings generated by the class
        :rtype: list
        """
