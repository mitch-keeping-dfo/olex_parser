...
class TurDataFile:
    ...
    :var self.full_path: the full path and filename for the Turdata file
    :var self.tur_turs: A dictionary of :class:`TurTurs<olexparser.turtur.TurTur>` with
        k:v TurTur Number: :class:`TurTur<olexparser.turtur.TurTur>`
    :var self.warnings: A list of warnings generated by the :class:`TurDataFile<olexparser.turdata_file.TurDataFile>`
    """
    ...
    def read_tur_data_file(self):
        ...
        A :class:`TurTur<olexparser.turtur.TurTur>` object is created for each Tur Tur.
        See :class:`TurTur<olexparser.turtur.TurTur>` for a description of a TurTur.
        The TurTur object added to the dict self.tur_turs with it's Tur Tur number as the key.
        """
    ...
    def get_turtur(self, number):
        """Returns the :class:`TurTur<olexparser.turtur.TurTur>` object identified by the Tur Tur number

        :param number: The Tur Tur number to retrieve.
        :type number: int
        :return: the :class:`TurTur<olexparser.turtur.TurTur>` object identified by the Tur Tur number.
        :rtype: :class:`TurTur<olexparser.turtur.TurTur>`
        """
    ...
    def to_gpx(self):
        """
        :return: The data from the :class:`TurDataFile<olexparser.turdata_file.TurDataFile>`
            as a :class:`gpxpy.gpx.GPX` object
